 ...
 */
package com.team.dream.runlegwork.chatutils;
...
//    private byte[] yuv_Rotate90lr;
     ...
     * 开启相机拍摄
     */
    @SuppressLint("NewApi") public void startCapture(){
        try {
...
//            yuv_Rotate90lr = new byte[mwidth * mheight * bitsperpixel / 8];
    ...
    boolean isScreenOriatationPortrait() {
        return DataApplication.getInstance().getResources().getConfiguration().orientation == Configuration.ORIENTATION_PORTRAIT;
    }
}
