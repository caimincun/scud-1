 ...
 */
package com.team.dream.runlegwork.adapter.chat;
...
import com.team.dream.runlegwork.video.util.ImageCache;
...
//	        UserUtils.setCurrentUserAvatar(context, imageView);
	        SingletonServiceManager.getInstance().display(AccountManager.USER_HEAD_DOWNLOAD_PATH+AccountManager.getInstance().getUserinfo().getUserInfoPicture(), imageView, R.drawable.user_default_head, null);
	    }else{
//	        UserUtils.setUserAvatar(context, message.getFrom(), imageView);
	        SingletonServiceManager.getInstance().display("", imageView, R.drawable.default_avatar, null);
	    }
