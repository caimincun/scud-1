 ...
 *******************************************************************************/
package com.team.dream.imageloader.core;
...
import com.team.dream.imageloader.cache.disc.DiskCache;
import com.team.dream.imageloader.cache.disc.naming.FileNameGenerator;
import com.team.dream.imageloader.cache.memory.MemoryCache;
import com.team.dream.imageloader.cache.memory.impl.FuzzyKeyMemoryCache;
import com.team.dream.imageloader.core.assist.FlushedInputStream;
import com.team.dream.imageloader.core.assist.ImageSize;
import com.team.dream.imageloader.core.assist.QueueProcessingType;
import com.team.dream.imageloader.core.decode.ImageDecoder;
import com.team.dream.imageloader.core.download.ImageDownloader;
import com.team.dream.imageloader.core.process.BitmapProcessor;
import com.team.dream.imageloader.utils.L;
import com.team.dream.imageloader.utils.MemoryCacheUtils;
...
public final class ImageLoaderConfiguration {
	 ...
	 * <li>diskCache = {@link com.team.dream.imageloader.cache.disc.impl.UnlimitedDiskCache}</li>
	...
	public static class Builder {
		...
		/**
		 * @deprecated Use
		 * {@link #diskCacheExtraOptions(int, int, com.team.dream.imageloader.core.process.BitmapProcessor)}
		 * instead
		 */
		@Deprecated
		 ...
		 * <b>NOTE:</b> If you use this method then
		 * {@link com.team.dream.imageloader.cache.disc.impl.ext.LruDiskCache LruDiskCache}
		...
		/** @deprecated Use {@link #diskCacheFileNameGenerator(com.team.dream.imageloader.cache.disc.naming.FileNameGenerator)} */
		@Deprecated
		 ...
		 * Default value -
		 * {@link com.team.dream.imageloader.core.DefaultConfigurationFactory#createFileNameGenerator()
		...
		/** @deprecated Use {@link #diskCache(com.team.dream.imageloader.cache.disc.DiskCache)} */
		@Deprecated
		 ...
		 * Default value - {@link com.team.dream.imageloader.cache.disc.impl.UnlimitedDiskCache
		 * UnlimitedDiskCache}. Cache directory is defined by
		 * {@link com.team.dream.imageloader.utils.StorageUtils#getCacheDirectory(Context)
		 ...
		 * Default value -
		 * {@link com.team.dream.imageloader.core.DefaultConfigurationFactory#createImageDownloader(Context)
		 ...
		 * Default value -
		 * {@link com.team.dream.imageloader.core.DefaultConfigurationFactory#createImageDecoder(boolean)
		 ...
		 * Consider {@link com.team.dream.imageloader.utils.L#disableLogging()} to disable
	 ...
	 * using {@link com.team.dream.imageloader.core.assist.FlushedInputStream}.
	 *
	 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
	 * @since 1.8.1
	 */
