...
public class Oauth {
     ...
     */
    public String getCode(String localRedirectUrl) throws UnsupportedEncodingException {
        Map<String, String> params = new HashMap<>();
        params.put("appid", getAppid());
        params.put("response_type", "code");
        params.put("redirect_uri", URLEncoder.encode(ConfKit.get("redirect_uri")+localRedirectUrl, "UTF-8"));
