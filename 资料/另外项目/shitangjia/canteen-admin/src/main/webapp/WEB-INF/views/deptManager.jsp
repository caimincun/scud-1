...
<div class="page-content">
  ...
  <table  class="table table-striped table-bordered table-hover">
    ...
    <tbody>
    <c:forEach var="canteenDept" items="${canteenDeptList}">
      <tr>
        ...
        <td>
          ...
          <c:out value="${canteenDept.deptName}"/>

        </td>
        <td>
          <div class="visible-md visible-lg hidden-sm hidden-xs btn-group">
            <button class="btn btn-xs btn-info" onclick="update(${canteenDept.id})">
  ...
  <script language="javascript">
    ...
    function update(id){
//      alert(id);
      window.location.href="/dept/getDeptAndAuthority?id="+id;
    }
